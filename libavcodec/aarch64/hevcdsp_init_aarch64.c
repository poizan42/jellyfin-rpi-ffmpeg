...
void ff_hevc_put_hevc_epel_uni_v_10_neon(uint8_t *dst, ptrdiff_t dststride,
    const uint8_t *src, ptrdiff_t srcstride, int height, intptr_t mx, intptr_t my, int width);
void ff_hevc_put_hevc_qpel_h_10_neon(int16_t *dst,
    const uint8_t *src, ptrdiff_t srcstride, int height, intptr_t mx, intptr_t my, int width);
void ff_hevc_put_hevc_qpel_v_10_neon(int16_t *dst,
    const uint8_t *src, ptrdiff_t srcstride, int height, intptr_t mx, intptr_t my, int width);
void ff_hevc_put_hevc_qpel_hv_10_neon(int16_t *dst,
    const uint8_t *src, ptrdiff_t srcstride, int height, intptr_t mx, intptr_t my, int width);
void ff_hevc_put_hevc_epel_h_10_neon(int16_t *dst,
    const uint8_t *src, ptrdiff_t srcstride, int height, intptr_t mx, intptr_t my, int width);
void ff_hevc_put_hevc_epel_v_10_neon(int16_t *dst,
    const uint8_t *src, ptrdiff_t srcstride, int height, intptr_t mx, intptr_t my, int width);
void ff_hevc_put_hevc_epel_hv_10_neon(int16_t *dst,
    const uint8_t *src, ptrdiff_t srcstride, int height, intptr_t mx, intptr_t my, int width);
void ff_hevc_put_hevc_pel_bi_pixels_10_neon(uint8_t *dst, ptrdiff_t dststride,
...
void ff_hevc_put_hevc_qpel_bi_hv_10_neon(uint8_t *dst, ptrdiff_t dststride,
    const uint8_t *src, ptrdiff_t srcstride, const int16_t *src2, int height, intptr_t mx, intptr_t my, int width);
void ff_hevc_put_hevc_epel_bi_h_10_neon(uint8_t *dst, ptrdiff_t dststride,
    const uint8_t *src, ptrdiff_t srcstride, const int16_t *src2, int height, intptr_t mx, intptr_t my, int width);
void ff_hevc_put_hevc_epel_bi_v_10_neon(uint8_t *dst, ptrdiff_t dststride,
    const uint8_t *src, ptrdiff_t srcstride, const int16_t *src2, int height, intptr_t mx, intptr_t my, int width);
...
/* weighted bi-pred (bi_w): (dst,dststride,src,srcstride,src2,height,denom,wx0,wx1,ox0,ox1,mx,my,width) */
void ff_hevc_put_hevc_pel_bi_w_pixels_10_neon(uint8_t *dst, ptrdiff_t dststride, const uint8_t *src, ptrdiff_t srcstride, const int16_t *src2, int height, int denom, int wx0, int wx1, int ox0, int ox1, intptr_t mx, intptr_t my, int width);
void ff_hevc_put_hevc_qpel_bi_w_h_10_neon(uint8_t *dst, ptrdiff_t dststride, const uint8_t *src, ptrdiff_t srcstride, const int16_t *src2, int height, int denom, int wx0, int wx1, int ox0, int ox1, intptr_t mx, intptr_t my, int width);
void ff_hevc_put_hevc_qpel_bi_w_v_10_neon(uint8_t *dst, ptrdiff_t dststride, const uint8_t *src, ptrdiff_t srcstride, const int16_t *src2, int height, int denom, int wx0, int wx1, int ox0, int ox1, intptr_t mx, intptr_t my, int width);
void ff_hevc_put_hevc_qpel_bi_w_hv_10_neon(uint8_t *dst, ptrdiff_t dststride, const uint8_t *src, ptrdiff_t srcstride, const int16_t *src2, int height, int denom, int wx0, int wx1, int ox0, int ox1, intptr_t mx, intptr_t my, int width);
void ff_hevc_put_hevc_epel_bi_w_h_10_neon(uint8_t *dst, ptrdiff_t dststride, const uint8_t *src, ptrdiff_t srcstride, const int16_t *src2, int height, int denom, int wx0, int wx1, int ox0, int ox1, intptr_t mx, intptr_t my, int width);
void ff_hevc_put_hevc_epel_bi_w_v_10_neon(uint8_t *dst, ptrdiff_t dststride, const uint8_t *src, ptrdiff_t srcstride, const int16_t *src2, int height, int denom, int wx0, int wx1, int ox0, int ox1, intptr_t mx, intptr_t my, int width);
void ff_hevc_put_hevc_epel_bi_w_hv_10_neon(uint8_t *dst, ptrdiff_t dststride, const uint8_t *src, ptrdiff_t srcstride, const int16_t *src2, int height, int denom, int wx0, int wx1, int ox0, int ox1, intptr_t mx, intptr_t my, int width);
...
void ff_hevc_put_hevc_pel_bi_w_pixels_12_neon(uint8_t *dst, ptrdiff_t dststride, const uint8_t *src, ptrdiff_t srcstride, const int16_t *src2, int height, int denom, int wx0, int wx1, int ox0, int ox1, intptr_t mx, intptr_t my, int width);
void ff_hevc_put_hevc_qpel_bi_w_h_12_neon(uint8_t *dst, ptrdiff_t dststride, const uint8_t *src, ptrdiff_t srcstride, const int16_t *src2, int height, int denom, int wx0, int wx1, int ox0, int ox1, intptr_t mx, intptr_t my, int width);
void ff_hevc_put_hevc_qpel_bi_w_v_12_neon(uint8_t *dst, ptrdiff_t dststride, const uint8_t *src, ptrdiff_t srcstride, const int16_t *src2, int height, int denom, int wx0, int wx1, int ox0, int ox1, intptr_t mx, intptr_t my, int width);
void ff_hevc_put_hevc_qpel_bi_w_hv_12_neon(uint8_t *dst, ptrdiff_t dststride, const uint8_t *src, ptrdiff_t srcstride, const int16_t *src2, int height, int denom, int wx0, int wx1, int ox0, int ox1, intptr_t mx, intptr_t my, int width);
void ff_hevc_put_hevc_epel_bi_w_h_12_neon(uint8_t *dst, ptrdiff_t dststride, const uint8_t *src, ptrdiff_t srcstride, const int16_t *src2, int height, int denom, int wx0, int wx1, int ox0, int ox1, intptr_t mx, intptr_t my, int width);
void ff_hevc_put_hevc_epel_bi_w_v_12_neon(uint8_t *dst, ptrdiff_t dststride, const uint8_t *src, ptrdiff_t srcstride, const int16_t *src2, int height, int denom, int wx0, int wx1, int ox0, int ox1, intptr_t mx, intptr_t my, int width);
void ff_hevc_put_hevc_epel_bi_w_hv_12_neon(uint8_t *dst, ptrdiff_t dststride, const uint8_t *src, ptrdiff_t srcstride, const int16_t *src2, int height, int denom, int wx0, int wx1, int ox0, int ox1, intptr_t mx, intptr_t my, int width);
...
av_cold void ff_hevc_dsp_init_aarch64(HEVCDSPContext *c, const int bit_depth)
{
    ...
    if (bit_depth == 10) {
        ...
        for (int i = 1; i <= 9; i++) {
            ...
            /* plain put (int16 out) — the bi-pred ref0 intermediate. */
            c->put_hevc_qpel[i][0][1] = ff_hevc_put_hevc_qpel_h_10_neon;
            c->put_hevc_qpel[i][1][0] = ff_hevc_put_hevc_qpel_v_10_neon;
            c->put_hevc_qpel[i][1][1] = ff_hevc_put_hevc_qpel_hv_10_neon;
            c->put_hevc_epel[i][0][1] = ff_hevc_put_hevc_epel_h_10_neon;
            c->put_hevc_epel[i][1][0] = ff_hevc_put_hevc_epel_v_10_neon;
            c->put_hevc_epel[i][1][1] = ff_hevc_put_hevc_epel_hv_10_neon;
            /* bi-pred (reads src2). pixels(00) is filter-agnostic (shared). */
            c->put_hevc_qpel_bi[i][0][0] =
            c->put_hevc_epel_bi[i][0][0] = ff_hevc_put_hevc_pel_bi_pixels_10_neon;
            c->put_hevc_qpel_bi[i][0][1] = ff_hevc_put_hevc_qpel_bi_h_10_neon;
            c->put_hevc_qpel_bi[i][1][0] = ff_hevc_put_hevc_qpel_bi_v_10_neon;
            c->put_hevc_qpel_bi[i][1][1] = ff_hevc_put_hevc_qpel_bi_hv_10_neon;
            ...
            c->put_hevc_qpel_bi_w[i][0][0] =
            c->put_hevc_epel_bi_w[i][0][0] = ff_hevc_put_hevc_pel_bi_w_pixels_10_neon;
            c->put_hevc_qpel_bi_w[i][0][1] = ff_hevc_put_hevc_qpel_bi_w_h_10_neon;
            c->put_hevc_qpel_bi_w[i][1][0] = ff_hevc_put_hevc_qpel_bi_w_v_10_neon;
            c->put_hevc_qpel_bi_w[i][1][1] = ff_hevc_put_hevc_qpel_bi_w_hv_10_neon;
            c->put_hevc_epel_bi_w[i][0][1] = ff_hevc_put_hevc_epel_bi_w_h_10_neon;
            c->put_hevc_epel_bi_w[i][1][0] = ff_hevc_put_hevc_epel_bi_w_v_10_neon;
            c->put_hevc_epel_bi_w[i][1][1] = ff_hevc_put_hevc_epel_bi_w_hv_10_neon;
        }
    }
    if (bit_depth == 12) {
        ...
        for (int i = 1; i <= 9; i++) {
            ...
            c->put_hevc_qpel_bi_w[i][0][0] =
            c->put_hevc_epel_bi_w[i][0][0] = ff_hevc_put_hevc_pel_bi_w_pixels_12_neon;
            c->put_hevc_qpel_bi_w[i][0][1] = ff_hevc_put_hevc_qpel_bi_w_h_12_neon;
            c->put_hevc_qpel_bi_w[i][1][0] = ff_hevc_put_hevc_qpel_bi_w_v_12_neon;
            c->put_hevc_qpel_bi_w[i][1][1] = ff_hevc_put_hevc_qpel_bi_w_hv_12_neon;
            c->put_hevc_epel_bi_w[i][0][1] = ff_hevc_put_hevc_epel_bi_w_h_12_neon;
            c->put_hevc_epel_bi_w[i][1][0] = ff_hevc_put_hevc_epel_bi_w_v_12_neon;
            c->put_hevc_epel_bi_w[i][1][1] = ff_hevc_put_hevc_epel_bi_w_hv_12_neon;
        }
    }
}
